...
object SoccerConfig : SportConfig {
    ...
    override val formationTemplates = listOf(
        ...
        FormationTemplate(
            ...
            slots = listOf(
                FormationSlot(1, 0.50f, 0.06f),
                FormationSlot(4, 0.72f, 0.20f),
                FormationSlot(6, 0.50f, 0.17f),
                FormationSlot(5, 0.28f, 0.20f),
        ...
        FormationTemplate(
            ...
            slots = listOf(
                FormationSlot(1, 0.50f, 0.06f),
                FormationSlot(2, 0.90f, 0.32f),
                FormationSlot(4, 0.68f, 0.20f),
                FormationSlot(6, 0.50f, 0.17f),
                FormationSlot(5, 0.32f, 0.20f),
                FormationSlot(3, 0.10f, 0.32f),
